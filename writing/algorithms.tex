...
\While {Level > 0}
\State find NextNode using \texttt{adapted\_dijkstra\_multisource}
...
\State Level = Level - 1	
\EndWhile
\State Suffix = \texttt{DijksCycle($A_{p,d}$,NextNode)}
